...
-- Insertion d'un administrateur par défaut (username: admin, password: admin123) avec accès à tous les périmètres
INSERT INTO
    admins (username, password, perimeter)
VALUES (
        'admin',
        '$2y$10$8MILqtJ.Ug1rO81p7wtMkuP89pa5BzQYRdTN0q5h.JLRDn5mN8JxW',
        'all'
    );

-- Insertion d'administrateurs spécifiques pour chaque périmètre
INSERT INTO
    admins (username, password, perimeter)
VALUES (
        'admin_campus',
...
INSERT INTO
    break_slots (period, start_time, end_time)
VALUES (
        'morning',
        '09:00:00',
        '09:10:00'
...
-- Ajouter la colonne perimeter à la table admins
ALTER TABLE admins
ADD COLUMN perimeter ENUM(
    'campus',
    'entreprise',
    'asn',
    'all'
...
UPDATE admins SET perimeter = 'all' WHERE username = 'admin';

-- Ajouter les administrateurs spécifiques s'ils n'existent pas déjà
INSERT IGNORE INTO
    admins (username, password, perimeter)
VALUES (
        'admin_campus',
