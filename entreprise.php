...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reserve'])) {
    ...
    if (empty($employee_name)) {
        ...
        $employee_name = "[ENTREPRISE] " . $employee_name;
...
<head>
    ...
    <title>Gestion des Pauses - Entreprise</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="my-breaks.php?perimeter=entreprise">
                            <i class="fas fa-calendar-check me-1"></i>Mes pauses
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="activate-break.php?perimeter=entreprise">
    ...
    <div class="container py-5">
        <div class="row justify-content-center mb-4">
            <div class="col-lg-10 text-center">
                <h1 class="h2 mb-3"><i class="fas fa-building me-2 text-success"></i>Espace Entreprise</h1>
                <p class="lead mb-0">Bienvenue dans l'espace de gestion des pauses pour les techniciens du périmètre Entreprise</p>
            </div>
        </div>
        ...
        <?php if ($success): ?>
            ...
            <div class="alert alert-info">
                ...
                <p>N'oubliez pas d'<a href="activate-break.php?perimeter=entreprise" class="alert-link">activer votre pause</a> au moment de la prendre.</p>
                <p>Vous pouvez également consulter vos pauses réservées en cliquant sur <a href="my-breaks.php?perimeter=entreprise" class="alert-link">Mes pauses</a>.</p>
            </div>
        <?php endif; ?>
            ...
            <div class="col-lg-10">
                <div class="card shadow mb-4">
                    <div class="card-header bg-primary text-white">
                        <h1 class="h4 mb-0"><i class="fas fa-calendar-alt me-2"></i>Réservation de Pauses - Entreprise</h1>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            <p class="mb-0">Bienvenue sur l'application de gestion des pauses pour le périmètre Entreprise. Vous pouvez réserver un créneau de 10 minutes pour votre pause du matin et de l'après-midi.</p>
                            <p class="mb-0"><strong>Important:</strong> N'oubliez pas d'activer votre pause au moment de la prendre en utilisant la page <a href="activate-break.php?perimeter=entreprise" class="alert-link">Activer ma pause</a>.</p>
                            <p class="mb-0"><strong>Limite:</strong> 3 employés maximum par créneau</p>
                        </div>

                        <form action="entreprise.php" method="post" class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text text-muted">Votre nom sera automatiquement préfixé par [ENTREPRISE]</div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="list-group mb-3">
                                        <?php foreach ($morning_slots as $slot): ?>
                                            ...
                                            $isActive = isSlotActive($slot['id'], 'entreprise');
    ...
    <script>
        ...
        function refreshSlots() {
            fetch('ajax/refresh-slots.php?perimeter=entreprise')
